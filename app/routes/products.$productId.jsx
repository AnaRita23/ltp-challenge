import { Link, useLoaderData, Form, useLocation, useRouteLoaderData, useNavigate } from "@remix-run/react";
...
export default function ProductDetail() {
  ...
  useEffect(() => {
    ...
    if (params.get("added") === "1") {
      ...
      const t = setTimeout(() => {
        setShowToast(false);
        params.delete("added"); // clean the URL
    ...
    <div className="productDetail container">
      ...
      <div className="sidebar">
        <div className="info">
          ...
          {showToast && <div className="cartToast">Added to cart</div>}
